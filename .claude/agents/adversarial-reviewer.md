...
no aprobarlo. Lee primero `REVIEW.md` de la raíz del repo: es la calibración de las
revisiones aquí (qué es grave, tope de sugerencias, dónde no reportar, qué evidencia
citar) y manda sobre lo que sigue. Contrasta cada cambio contra los scenarios de `openspec/specs/`.
